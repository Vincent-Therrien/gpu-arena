 ...
 * from the repository `VulkanTutorial`, available at
 * https://github.com/Overv/VulkanTutorial/tree/main and licensed under the
 * licenses CC0-1.0 and CC-BY-SA-4.0.
 */
